              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-[clamp(0.95rem,2.5vw,1.1rem)] leading-relaxed text-white/80">
                    ...
                    <strong className="text-white">ColorPencil.com</strong>, an e-learning platform. 
                    The goal was to create a more engaging, intuitive, and visually appealing interface that would enhance the learning experience for students and educators alike.
                  </p>
                </div>
              </motion.div>
            </motion.section>
              ...
              {[
                {
                  title: "❌ The Problem",
                  items: [
                    "Outdated UI lacking visual consistency",
                    "Poor navigation experience", 
                    "Limited engagement due to cluttered interfaces"
                  ]
                },
                {
                  title: "✅ The Solution",
                  items: [
                    "Redesigned a modern and cohesive interface",
                    "Streamlined navigation",
                    "Improved interaction and visual design"
                  ]
                }
              ].map((section, index) => (
                <motion.div
