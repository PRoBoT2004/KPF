...
const BioconBiologicsCaseStudy = () => {
    ...
    const images = [
        ...
        "/assets/bc3.png",
        "/assets/bc4.png",
        // "/assets/biocon5.png", // Add more images as necessary
    ];
            ...
            <div className="relative z-10 p-8 bg-black bg-opacity-50">
                ...
                <section className="max-w-5xl py-32 mx-auto text-center">
                    ...
                    <p className="text-xl text-gray-300">
                        Revamping Biocon Biologics’ digital presence to enhance accessibility and provide better user engagement for healthcare professionals and patients.
                    </p>
                </section>
                ...
                <section className="max-w-4xl mx-auto mb-16 text-white">
                    ...
                    <p className="text-lg leading-relaxed text-gray-200">
                        Biocon Biologics is a global leader in biosimilars and biologics. The website redesign aimed to improve user navigation, accessibility, and content presentation, ensuring that both healthcare professionals and patients could easily find the critical information they needed. The goal was to make the platform modern, user-friendly, and responsive while maintaining the brand's authoritative presence in the biotech industry.
                    </p>
                </section>
                ...
                <section className="flex flex-wrap justify-between max-w-4xl gap-8 mx-auto mb-16">
                    <div className="flex-1 p-8 border-gray-700 rounded-lg shadow-lg bg-opacity-30 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 backdrop-blur-xl">
                        ...
                        <ul className="pl-6 space-y-2 text-white list-disc">
                            <li>Outdated design with complex navigation</li>
                            <li>Inconsistent user experience across devices</li>
                            <li>Lack of clear categorization for healthcare professionals and patients</li>
                        </ul>
                    </div>
                    ...
                    <div className="flex-1 p-8 border-gray-700 rounded-lg shadow-lg bg-opacity-30 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 backdrop-blur-xl">
                        ...
                        <ul className="pl-6 space-y-2 text-white list-disc">
                            <li>Modern, responsive design for a seamless experience</li>
                            <li>Improved navigation with intuitive sections for professionals and patients</li>
                            <li>Clear and structured content to improve access to vital resources</li>
                        </ul>
                    </div>
                </section>
