  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-black">
      ...
      <div className="relative z-10 pt-24 sm:pt-32 pb-24">
        ...
        <Section className="mb-16">
          ...
          >
            ...
            <p className="text-[clamp(1rem,2.5vw,1.2rem)] text-white/80 max-w-[70ch] mx-auto">
              Minimal, fast, and data‑driven. Built with React, Tailwind, and live market data.
            </p>
          </motion.div>
        </Section>
        ...
        {/* <Section className="mb-16">
          <motion.div
            className="group relative overflow-hidden rounded-3xl border border-white/10 bg-white/5 p-4 backdrop-blur-sm max-w-5xl mx-auto"
          ...
          > */}
            {/* <div className="relative overflow-hidden rounded-2xl aspect-[16/9] w-full">
              <motion.video
                ...
                playsInline
              >
                <source src="/assets/BAUI.mp4" type="video/mp4" />
              </motion.video>
          ...
          <div className="mx-auto max-w-5xl grid grid-cols-1 gap-6 lg:grid-cols-2">
            ...
            >
              ...
              <p className="text-white/80 leading-relaxed text-base">
                CryptoDash showcases a clean, performant SPA with live market data via CoinGecko. It emphasizes
                clarity, responsiveness, and smooth micro‑interactions over heavy visuals.
              </p>
            </motion.div>
            <motion.div
              className="rounded-2xl border border-white/10 bg-white/5 p-6 backdrop-blur-sm"
            ...
            >
              ...
              <ul className="list-disc list-inside text-white/80 space-y-2 text-base">
                <li>React + Tailwind, component‑driven architecture</li>
                <li>CoinGecko REST API for live pricing</li>
                <li>Responsive layout and keyboard accessible UX</li>
                <li>Debounced search, skeleton states, error handling</li>
              </ul>
            </motion.div>
          </div>
        </Section>
        ...
        <Section className="mb-20">
          <motion.div
            ...
            transition={{ duration: 0.4, delay: 0.1 }}
          >
            <h3 className="text-white text-xl font-semibold mb-3">Architecture & Performance</h3>
            <p className="text-white/80 leading-relaxed text-base">
              Built with modular UI and hooks. State updates are optimized and effects are debounced where necessary.
              Utility‑first styling avoids bloat, and animations are subtle to keep focus on content.
            </p>
          </motion.div>
        </Section>
        ...
        <Section className="mb-12">
          ...
          >
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              ...
              <a
                href="https://github.com/PRoBoT2004/CryptoDash"
                target="_blank"
                rel="noopener noreferrer"
